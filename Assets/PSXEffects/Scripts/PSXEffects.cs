...
public class PSXEffects : MonoBehaviour {
	...
	public System.Version version = new System.Version("1.16.1");
	...
	public void UpdateProperties() {
		...
		Shader.SetGlobalFloat(propIds[0], affineMapping ? 1.0f : 0.0f);
		...
		Shader.SetGlobalFloat(propIds[6], worldSpaceSnapping ? 1.0f : 0.0f);
		Shader.SetGlobalFloat(propIds[7], camSnapping ? 1.0f : 0.0f);
		Shader.SetGlobalFloat(propIds[8], shadowType);
